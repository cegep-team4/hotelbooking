    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top: 30px;">
                ...
                <div class="well"><a href="managecities.php">Cities</a></div>
            </div>

            <div class="col-md-4" style="margin-top: 30px;">

               <div class="well"><a href="managehotels.php">Hotels</a></div>
              
               
            </div>

            <div class="col-md-4" style="margin-top: 30px;">
                <div class="well"><a href="managerooms.php">Hotel Rooms</a></div>
            </div>
            
             <div class="col-md-4" style="margin-top: 30px;">
                <div class="well"><a href="managedeals.php">Hotel Deals</a></div>
            </div>
        </div>
    </div>
